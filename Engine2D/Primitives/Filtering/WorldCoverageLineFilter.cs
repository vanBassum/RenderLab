...
namespace Engine2D.Primitives.Filtering
{
    ...
    {
        public bool IsVisible(IPrimitive2D primitive, Camera2D camera, IViewport2D viewport, WorldVector worldMin, WorldVector worldMax)
        {
        ...
        private static bool LineIntersectsAabb(WorldVector a, WorldVector b, WorldVector min, WorldVector max)
        {
